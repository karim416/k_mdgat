...
# -*- coding: utf-8 -*-
"""
Created on Wed May 25 10:42:04 2022
...
if __name__ == '__main__':
    ...
    path_checkpoint1 = parentdir+'/part1.pth'          
    checkpoint1 = torch.load(path_checkpoint1,map_location=device)#{'cuda:2':'cuda:0'})  
...
#    MG1.load_state_dict(checkpoint1['net'])   
